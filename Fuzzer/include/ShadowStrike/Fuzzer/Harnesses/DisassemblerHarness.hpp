...
#pragma once
/**
 * @file DisassemblerHarness.hpp
 * @brief Fuzz harness for PhantomDisassembler Decoder::DecodeFull().
 *
 * Exercises the disassembler across all supported machine modes, validates
 * decoder invariants on successful decodes, and wraps decoder execution in
 * Windows SEH to survive hardware faults during in-process fuzzing.
 */
...
[[nodiscard]] int RunDisassemblerFuzzer(
