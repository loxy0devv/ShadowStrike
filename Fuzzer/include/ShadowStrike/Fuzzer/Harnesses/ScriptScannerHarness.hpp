...
#pragma once
/**
 * @file ScriptScannerHarness.hpp
 * @brief Fuzz harness for ShadowStrike script scanners.
 *
 * Exercises PowerShell, JavaScript, Python, and VBScript in-memory scanning
 * entry points under Windows SEH so malformed buffers cannot terminate the
 * fuzzing campaign without being recorded.
 */
...
[[nodiscard]] int RunScriptScannerFuzzer(
