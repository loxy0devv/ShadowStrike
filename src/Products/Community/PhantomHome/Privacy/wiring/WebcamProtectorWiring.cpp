        ...
        try {
            ...
            HomeProductOrchestrator::Instance().RegisterModule(ModuleDescriptor{
                ...
                .setMode = [](ProtectionMode mode) -> bool {
                    using MMode = ::ShadowStrike::Privacy::WebcamProtectionMode;
                    ...
                    return ApplyModeThresholds("WebcamProtector", mode);
                },
...
// ---------------------------------------------------------------------------
extern "C" void PhantomHome_KeepAlive_WebcamProtector() noexcept {}