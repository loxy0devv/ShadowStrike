...
#pragma once
/**
 * @file AntiEvasionHarness.hpp
 * @brief Fuzz harness for ShadowStrike anti-evasion detectors.
 *
 * Exercises packer analysis and anti-VM code-buffer inspection under Windows
 * SEH so malformed executable payloads cannot terminate in-process fuzzing.
 */
...
[[nodiscard]] int RunAntiEvasionFuzzer(
