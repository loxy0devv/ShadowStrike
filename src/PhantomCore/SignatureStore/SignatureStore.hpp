    ...
    namespace SignatureStore {
        ...
        public:
            ...
            struct GlobalStatistics {
                ...
                HashStore::StoreStatistics hashStats;
                PatternStore::StoreStatistics patternStats;
            ...
            [[nodiscard]] HashStore::StoreStatistics GetHashStatistics() const noexcept;
            [[nodiscard]] PatternStore::StoreStatistics GetPatternStatistics() const noexcept;
        ...
        private:
            ...
            // Component stores
            std::unique_ptr<HashStore::HashStore> m_hashStore;
            std::unique_ptr<PatternStore::PatternStore> m_patternStore;
