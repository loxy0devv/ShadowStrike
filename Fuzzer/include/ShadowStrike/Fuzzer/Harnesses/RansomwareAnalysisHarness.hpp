...
#pragma once
/**
 * @file RansomwareAnalysisHarness.hpp
 * @brief Fuzz harness for ShadowStrike ransomware analysis detectors.
 *
 * Exercises entropy analysis plus WannaCry and Locky family indicator checks
 * under Windows SEH so malformed inputs cannot terminate the fuzzing campaign
...
class RansomwareAnalysisHarness {
public:
...
[[nodiscard]] int RunRansomwareAnalysisFuzzer(
