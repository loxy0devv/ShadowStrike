...
#pragma once
/**
 * @file CryptoCertHarness.hpp
 * @brief Fuzz harness for ShadowStrike crypto and certificate utilities.
 *
 * Exercises certificate parsing, hash computation, key derivation, and
 * symmetric cryptographic round-trips under Windows SEH so malformed inputs
 * cannot terminate the fuzzing campaign without being recorded.
 */
...
[[nodiscard]] int RunCryptoCertFuzzer(
