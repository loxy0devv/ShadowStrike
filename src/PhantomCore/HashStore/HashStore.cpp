...
namespace ShadowStrike {
    namespace HashStore {
            ...
            , m_perfFrequency{}
        {
            ...
            // Note: m_queryCache is already zero-initialized via {} in member declaration
            // No need for explicit loop - atomic seqlocks are 0 (valid), hash/result/timestamp are default
        }
